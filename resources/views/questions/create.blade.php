...
<div
    ...
    <div class="d-flex flex-column justify-content-center">
        ...
        <p class="mb-0">{{ __('website.create_new_question') }}</p>
    </div>
    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form id="my-form" action="{{ route('question.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-sm-6 mb-3">
                            <div class="form-floating form-floating-outline">
                                <input type="text" name="question_text" class="form-control"
                                    placeholder="{{ __('website.enter_question_text') }}" value="{{ old('question_text') }}">
