    ...
    <div class="card-body">
        <div class="d-flex justify-content-between mb-3">
            ...
            <div class="col-lg-6 text-end">
                <a href="{{ route('meal.create') }}" class="btn btn-inverse-primary btn-sm btn-icon-text">
...
<script>
    ...
    var _datatable_js = $('#table_datatable').DataTable({
        ...
        columnDefs: [
            ...
            { name: "time_from", targets: 2 },
            { name: "time_to", targets: 3 },
        ...
        columns: [
            ...
            {
                title: "{{ __('website.time_from') }}",
                render: function (data, type, row) {
                    return `${row.time_from}`;
                },
            },
            {
                title: "{{ __('website.time_to') }}",
                render: function (data, type, row) {
                    return `${row.time_to}`;
                },
            },
