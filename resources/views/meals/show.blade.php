...
<div
    ...
    <div class="d-flex flex-column justify-content-center">
        ...
        <p class="mb-0">{{ __('website.view_and_manage_meals') }}</p>
    </div>
    ...
    <div class="card-body">
        <div class="d-flex justify-content-between mb-3">
            ...
            <div class="col-lg-6 text-end">
                <a class="me-3 text-muted" type="button" data-bs-toggle="tooltip"
                    data-bs-title="Created at: {{ $meal->created_at }}">
                    <i class="ri-timer-2-line"></i> {{ $meal->created_at->diffForHumans() }}
                </a>
                <a class="text-muted" type="button" data-bs-toggle="tooltip"
                    data-bs-title="Updated at: {{ $meal->updated_at }}">
                    <i class="ri-progress-5-line"></i> {{ $meal->updated_at->diffForHumans() }}
                </a>
            </div>
        </div>
        <div class="info-container">
            <ul class="list-unstyled mb-6">
                ...
                <li class="mb-2">
                    <span class="h6 me-1">{{ __('website.time') }}:</span>
                    <span>{{ $meal->time_from }} -> {{ $meal->time_to }}</span>
                </li>
                <li class="mb-2">
