...
<div
    ...
    <div class="d-flex flex-column justify-content-center">
        ...
        <p class="mb-0">{{ __('website.create_new_meal') }}</p>
    </div>
    ...
    <div class="col-md-12 grid-margin stretch-card">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form id="my-form" action="{{ route('meal.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        ...
                        <div class="col-sm-12 mb-3">
                            <div class="form-floating form-floating-outline">
                                <textarea type="text" name="description" class="form-control h-px-100"
                                    placeholder="{{ __('website.enter_description') }}">{{ old('description') }}</textarea>
