...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('assets/landing-page/dist/css/style.css') }}?v={{ config('app.version') }}">
...
<body class="is-boxed has-animations">
                ...
                <div class="container">
                    <div class="features-inner section-inner has-bottom-divider">
                        <div class="features-wrap">
                            @foreach ($section_titles as $key => $item)
                            <div class="feature text-center is-revealing">
                                <div class="feature-inner">
                                    <div class="feature-icon">
                                        <img
                                            src="{{ asset('assets/landing-page/dist/images/feature-icon-0'.($key+1).'.svg') }}?v={{ config('app.version') }}">
                                    </div>
                                    <h4 class="feature-title mt-24">{{ $item['title'] }}</h4>
    ...
    <script src="{{ asset('assets/landing-page/dist/js/main.min.js') }}?v={{ config('app.version') }}"></script>
</body>
